 ...
 *
 * This call allows you to create a disbursement object. A disbursement is a
 * collection of monetary transfers from a WePay account to an email address.
 * So if you want to send money from a WePay account to between 1 and
 * 1000 emails, use this call.
 *
...
public class WePayDisbursementCreateResponse extends WePayResponse {
